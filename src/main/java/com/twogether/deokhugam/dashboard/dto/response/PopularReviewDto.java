...
public record PopularReviewDto(
    @Schema(description = "인기 리뷰 랭킹 ID") UUID id,
    @Schema(description = "리뷰 ID") UUID reviewId,
    @Schema(description = "도서 ID") UUID bookId,
    @Schema(description = "도서 제목") String bookTitle,
    @Schema(description = "도서 썸네일 이미지 URL") String bookThumbnailUrl,
    @Schema(description = "사용자 ID") UUID userId,
    @Schema(description = "사용자 닉네임") String userNickname,
    @Schema(description = "리뷰 내용") String reviewContent,
    @Schema(description = "리뷰 평점") double reviewRating,
    @Schema(description = "랭킹 기간") RankingPeriod period,
    @Schema(description = "랭킹 생성 시각") Instant createdAt,
