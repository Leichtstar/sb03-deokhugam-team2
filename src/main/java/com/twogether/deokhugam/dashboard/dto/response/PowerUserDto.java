...
public record PowerUserDto(
    ...
    @Schema(description = "총 활동 점수") double score,
    @Schema(description = "작성한 리뷰의 총 인기 점수") double reviewScoreSum,
    @Schema(description = "좋아요 수") long likeCount,
    @Schema(description = "댓글 수") long commentCount
) {

    @QueryProjection
    public PowerUserDto(UUID userId, String nickname, RankingPeriod period, Instant createdAt, int rank,
